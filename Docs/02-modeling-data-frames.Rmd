...
fix_factors <- function(df) {
  df %>%
    mutate(
      Face_Amount = factor(Face_Amount),
      Face_Amount = forcats::fct_recode(
        Face_Amount,
        `<10K` = "1-9999",
        `10K-24K`="10000-24999",
        `25K-49K`="25000-49999",
        `50K-99K`="50000-99999",
        `100K-249K`="100000-249999",
        `250K-499K`="250000-499999",
        `500K-999K`="5000000-9999999",
        `1M-2.49M`="1000000-2499999",
        `2.5M-4.99M`="2500000-4999999",
        `5M-9.99M`="5000000-9999999",
        `10M+`="10000000+"
      )
    )
}
